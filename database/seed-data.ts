...
/* Creamos la interfaz de los usuarios de pruebas */
interface SeedUser {
    name: string
    email: string
    password: string
...
/* Agregamos el atributo 'users' el cual va a ser un arreglo de SeedUser */
interface SeedData {
    users: SeedUser[]
    ...
    users: [
        {
            ...
            email: 'catumontenegro@gmail.com',
            /* Utilizamos el metodo hashSync de bcrypt para encriptar las contraseñas */
            password: bcrypt.hashSync('123456'),
            role: 'client'
        },
        {
            name: 'Bautista Luciani',
            email: 'bautiluciani@gmail.com',
            password: bcrypt.hashSync('123456'),
            role: 'admin'
        }
    ],
